...
### Write simple Pythonu script

Your Pythonu script will receive data from wireless temperature and humidity sensors and will turn on the LED on the Core Module once the pre-defined values have been exceeded.
...
3. On the top right corner click on menu > import > clipboard and insert following text:
...
* On the top right corner click on menu > import > clipboard, choose new flow and insert following text:
...
Mayb it's a crazy idea, but you can see unlimited possibilities of your home automation :-)e
